...
class AdminWindow:
    ...
    def delete_data(self):
        self.selected = self.tree_view_users.selection()
        for row_id in self.selected:
            selected_id = row_id
            DatabaseLifeChoices().delete_user_data(selected_id)
    ...
    def attendance_register(self):
        ...
        self.tree_view_attendance.heading("Time Signed In", text="Time Signed In", anchor=CENTER)
        self.tree_view_attendance.heading("Time Signed Out", text="Time Signed Out", anchor=CENTER)
    ...
    #                                        "Kin Number", "Admin Rights", "Password")
    #     # Format Our Columns
    ...
    def users(self):
        ...
        self.tree_view_users["columns"] = ("User ID", "Name", "Surname", "Cell Number",
                                           "Kin Number", "Admin Rights", "Password", "ID Number", )
        # Format Our Columns
